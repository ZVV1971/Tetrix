...
namespace TetrisTests.Figures.RightHook
{
    internal class PositionTests
    {
        ...
        public void TestRightHookPositions(IList<Tuple<int, int>> pos, int res)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightHookRotation_OldPos_nonEqual_NewPos(IList<Tuple<int, int>> pos, int d)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightHookRotation_OldPos_NewPos_diffc_in_1(IList<Tuple<int, int>> pos, int d)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightHookRotation_DoubleRotation_theSame(IList<Tuple<int, int>> pos, int d)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightHookRotation_SingleRotation_theNext(IList<Tuple<int, int>> pos, int d)
        {
