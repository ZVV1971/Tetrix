...
namespace TetrisTests.Figures.RightSnake
{
    internal class PositionTests
    {
        ...
        public void TestRightSnakePositions(IList<Tuple<int, int>> pos, int res)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightSnakeRotation_OldPos_nonEqual_NewPos(IList<Tuple<int, int>> pos, int d)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightSnakeRotation_OldPos_NewPos_diffc_in_1(IList<Tuple<int, int>> pos, int d)
        {
        ...
        [Apartment(ApartmentState.STA)]
        public void TestRightSnakeRotation_DoubleRotation_theSame(IList<Tuple<int, int>> pos, int d)
        {
            Assert.AreEqual(ctrl.GetPositionNumber(pos), ctrl.GetPositionNumber(ctrl.Rotate(ctrl.Rotate(pos))));
        }

        [TestCaseSource(nameof(RightSnakePositions)), Description("Test that RightSnake figure being rotated returns in the next position")]
        [Apartment(ApartmentState.STA)]
        public void TestRightSnakeRotation_SingleRotation_theNext(IList<Tuple<int, int>> pos, int d)
        {
            Assert.AreEqual((d + 1) % RightSnakePositions.Length, ctrl.GetPositionNumber(ctrl.Rotate(pos)));
        }
