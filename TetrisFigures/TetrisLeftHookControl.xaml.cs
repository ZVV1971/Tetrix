...
{
    /// <summary>
    /// Interaction logic for TetrisLeftHookControl.xaml
    /// </summary>
    public partial class TetrisLeftHookControl : TetrisUserControl
    {
        public TetrisLeftHookControl()
        {
        ...
        {
            LeftHookControlWindow.Width = size * 3;
