...
{
    /// <summary>
    /// Interaction logic for BirdCrossControl.xaml
    /// </summary>
    [Complexity(Complexity = GameComplexity.Hard)]
    public partial class TetrisBirdControl : TetrisUserControl
    {
        public TetrisBirdControl()
        {
        ...
        {
            BirdControlWindow.Width = size * 3;
            BirdControlWindow.Height = size * 2;
        }
        ...
        public override int GetPositionNumber(IList<Tuple<int, int>> tuples)
        {
            ...
            {
                if (tuples[1].Item1 > tuples[2].Item1)
